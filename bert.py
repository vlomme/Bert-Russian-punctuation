...
sents = ["она переключила внимание на развивающийся прогулочный рынок состоящий из семей с независимым доходом", "думаю что поскольку теперь семьи живут не так близко как прежде"]
print(Bert_punctuation.predict(sents))